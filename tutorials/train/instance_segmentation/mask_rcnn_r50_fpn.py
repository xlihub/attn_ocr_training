...
# 检测FTP服务器中是否有新的模型数据集
src_dir_list = glob('/home/attnroot/ftp/upload/new_model/' + '*')
if len(src_dir_list) == 0:
    ...
    for src_file in src_dir_list:
        ...
        if len(namelist) > 1:
            ...
            filetype = namelist[1]
            if filetype == 'zip':
                dst_dir = '/home/attnroot/ftp/upload/model/'
                unzip_file(src_file, dst_dir)

# 将model文件夹中的所有model数据集汇总到base文件夹中
model_dir_list = glob('/home/attnroot/ftp/upload/model/' + '*')
for model_file in model_dir_list:
    distutils.dir_util.copy_tree(model_file + '/JPEGImages', '/home/attnroot/TrainData/base/JPEGImages')
    distutils.dir_util.copy_tree(model_file + '/Annotations', '/home/attnroot/TrainData/base/Annotations')

# 将base文件夹中的数据集转换成COCO格式，并保存到dataset_coco文件夹中
shutil.rmtree('/home/attnroot/TrainData/dataset_coco')
pdx.tools.dataset_conversion('labelme', 'MSCOCO', '/home/attnroot/TrainData/base/JPEGImages', '/home/attnroot/TrainData/base/Annotations', '/home/attnroot/TrainData/dataset_coco')

# 将dataset_coco文件夹中的数据集拷贝到CPA文件夹，准备开始训练
# shutil.rmtree('/home/attnroot/TrainData/CPA')
# shutil.copytree('/home/attnroot/TrainData/dataset_coco', '/home/attnroot/TrainData/CPA')
distutils.dir_util.copy_tree('/home/attnroot/TrainData/dataset_coco', '/home/attnroot/TrainData/CPA')

# 切分CPA文件夹中的数据集
pdx.tools.split.split_coco_dataset(
    '/home/attnroot/TrainData/CPA', 0.2, 0.1, '/home/attnroot/TrainData/CPA')
...
train_dataset = pdx.datasets.CocoDetection(
    data_dir='/home/attnroot/TrainData/CPA/JPEGImages',
    ann_file='/home/attnroot/TrainData/CPA/train.json',
    transforms=train_transforms,
    shuffle=True)
eval_dataset = pdx.datasets.CocoDetection(
    data_dir='/home/attnroot/TrainData/CPA/JPEGImages',
    ann_file='/home/attnroot/TrainData/CPA/val.json',
...
path = '/home/attnroot/ftp/upload/model'  # 文件夹建立位置
create_models_info(path)
mycopyfile('./models_info.txt', './maskrcnn_serving_server/')

# 将server文件夹拷贝到serving目录
distutils.dir_util.copy_tree('./maskrcnn_serving_server', '/home/attnroot/ppocr/maskrcnn_serving_server')

# 将server文件夹拷贝到TrainModel目录
path = create_folder(r'/home/attnroot/TrainModel')  # 文件夹建立位置
...
src_dir = './'
dst_dir = '/home/attnroot/ftp/upload/'
